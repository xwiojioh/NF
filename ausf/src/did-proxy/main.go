...
func main() {
	...
	// Step 1: Load OAI configuration (parallel with AUSF)
	...
	// Step 3: Generate NF Profile from configuration (parallel with AUSF)
	...
	log.Info("                                                  ")
	log.Info("  AUSF can now read this file for BCF registration ")
	log.Info("==================================================")
}
