...
class ausf_profile : public std::enable_shared_from_this<ausf_profile> {
 public:
  ...
  /*
   * Set NF instance PLMN support list
   * @param [std::vector<plmn_item_t> &] p: PLMN support list
   * @return void
   */
  void set_nf_plmn_list(const std::vector<plmn_item_t>& p);
  ...
  /*
   * Get NF instance PLMN support list
   * @param [std::vector<plmn_item_t> &] p: store instance's PLMN list
   * @return void:
   */
  void get_nf_plmn_list(std::vector<plmn_item_t>& p) const;
