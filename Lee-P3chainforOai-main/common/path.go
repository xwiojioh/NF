...
// MakeName creates a node name that follows the p3Chain convention
...
func DefaultDataDir() string {
	...
	if runtime.GOOS == "darwin" {
		...
		return filepath.Join(usr.HomeDir, "AppData", "Roaming", "P3-Chain")
	} else {
		return filepath.Join(usr.HomeDir, ".p3Chain")
	}
}
