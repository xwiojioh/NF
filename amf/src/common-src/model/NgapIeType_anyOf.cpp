...
void to_json(nlohmann::json& j, const NgapIeType_anyOf& o) {
  ...
  switch (o.getValue()) {
    ...
    case NgapIeType_anyOf::eNgapIeType_anyOf::EARLY_STATUS_TRANS_CONTAINER:
      ...
      break;
    case NgapIeType_anyOf::eNgapIeType_anyOf::UE_RADIO_CAPABILITY_FOR_PAGING:
      j = "UE_RADIO_CAPABILITY_FOR_PAGING";
      break;
  }
}
...
void from_json(const nlohmann::json& j, NgapIeType_anyOf& o) {
  ...
  } else if (s == "UE_RADIO_CAPABILITY_FOR_PAGING") {
    o.setValue(
        NgapIeType_anyOf::eNgapIeType_anyOf::UE_RADIO_CAPABILITY_FOR_PAGING);
  } else {
    std::stringstream ss;
