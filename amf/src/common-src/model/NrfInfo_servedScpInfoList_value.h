...
class NrfInfo_servedScpInfoList_value {
 public:
  ...
  /// </summary>
  std::map<std::string, oai::_3gpp::model::ScpDomainInfo> getScpDomainInfoList()
      const;
  ...
  void setScpCapabilities(
      std::vector<oai::_3gpp::model::ScpCapability> const& value);
  bool scpCapabilitiesIsSet() const;
  void unsetScpCapabilities();

  friend void to_json(
      nlohmann::json& j, const NrfInfo_servedScpInfoList_value& o);
  friend void from_json(
      const nlohmann::json& j, NrfInfo_servedScpInfoList_value& o);
