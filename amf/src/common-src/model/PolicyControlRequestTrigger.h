 ...
 * requested rule data is the successful resource allocation. - RAI_CH: Location
 * Change with respect to the RAI of GERAN and UTRAN. - RAT_TY_CH: RAT Type
 * Change. - REF_QOS_IND_CH: Reflective QoS indication Change -
 ...
 * USER_LOCATION_CH: Indicate that user location has been changed, applicable to
 * serving area change and serving cell change. - EPS_FALLBACK: EPS Fallback
 * report is enabled in the SMF. - MA_PDU: UE Indicates that the SMF notifies
 * the PCF of the MA PDU session request - TSN_BRIDGE_INFO: TSC user plane node
 * information available - 5G_RG_JOIN: The 5G-RG has joined to an IP Multicast
 * Group. - 5G_RG_LEAVE: The 5G-RG has left an IP Multicast Group. -
 ...
 * reports that UDM provided list of group Ids has changed. -
 ...
 * VPLMN. - SUCC_QOS_UPDATE: Indicates that the requested MPS Action is
 * successful. - SAT_CATEGORY_CHG: Indicates that the SMF has detected a change
 * between different satellite backhaul categories, or between a satellite
 * backhaul and a non-satellite backhaul. - PCF_UE_NOTIF_IND: Indicates the SMF
 * has detected the AMF forwarded the PCF for the UE indication to receive/stop
 * receiving notifications of SM Policy association established/terminated
 * events. - NWDAF_DATA_CHG: Indicates that the NWDAF instance IDs used for the
 * PDU session and/or associated Analytics IDs used for the PDU session and
...
/// allocation. - RAI_CH: Location Change with respect to the RAI of GERAN and
/// UTRAN. - RAT_TY_CH: RAT Type Change. - REF_QOS_IND_CH: Reflective QoS
...
/// UE_STATUS_RESUME: Indicates that the UE&#39;s status is resumed. - UE_TZ_CH:
/// UE Time Zone Change - AUTH_PROF_CH: The DN-AAA authorization profile index
/// has changed - QOS_MONITORING: Indicate that the SMF notifies the PCF of the
/// QoS Monitoring information. - SCELL_CH: Location Change with respect to the
/// Serving Cell. - USER_LOCATION_CH: Indicate that user location has been
/// changed, applicable to serving area change and serving cell change. -
...
/// TSN_BRIDGE_INFO: TSC user plane node information available - 5G_RG_JOIN: The
/// 5G-RG has joined to an IP Multicast Group. - 5G_RG_LEAVE: The 5G-RG has left
/// an IP Multicast Group. - DDN_FAILURE: Event subscription for DDN Failure
/// event received. - DDN_DELIVERY_STATUS: Event subscription for DDN Delivery
/// Status received. - GROUP_ID_LIST_CHG: UE Internal Group Identifier(s) has
/// changed: the SMF reports that UDM provided list of group Ids has changed. -
/// DDN_FAILURE_CANCELLATION: The event subscription for DDN Failure event is
/// cancelled. - DDN_DELIVERY_STATUS_CANCELLATION: The event subscription for
/// DDD STATUS is cancelled. - VPLMN_QOS_CH: Change of the QoS supported in the
/// VPLMN. - SUCC_QOS_UPDATE: Indicates that the requested MPS Action is
/// successful. - SAT_CATEGORY_CHG: Indicates that the SMF has detected a change
/// between different satellite backhaul categories, or between a satellite
/// backhaul and a non-satellite backhaul. - PCF_UE_NOTIF_IND: Indicates the SMF
