 ...
 * of the UE for the individual PRA identified by the additionalPraId IE;  If
 * the additionalPraId IE is not present, this IE shall state the presence
...
class PresenceInfoRm {
 public:
  ...
  /// encoded as a string representing an integer in the following ranges: - 0
  /// to 8 388 607 for UE-dedicated PRA - 8 388 608 to 16 777 215 for Core
  /// Network predefined PRA Examples: PRA ID 123 is encoded as
  /// \&quot;123\&quot; PRA ID 11 238 660 is encoded as \&quot;11238660\&quot;
  /// </summary>
