...
bool LocationQoS::validate(
  ...
  if (minorLocQosesIsSet()) {
    const std::vector<oai::_3gpp::model::MinorLocationQoS>& value =
        m_MinorLocQoses;
    ...
    {  // Recursive validation of array elements
      ...
      for (const oai::_3gpp::model::MinorLocationQoS& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".minorLocQoses") && success;
...
bool LocationQoS::operator==(const LocationQoS& rhs) const {
  return
      ...
      ((!minorLocQosesIsSet() && !rhs.minorLocQosesIsSet()) ||
       (minorLocQosesIsSet() && rhs.minorLocQosesIsSet() &&
        getMinorLocQoses() == rhs.getMinorLocQoses())) &&
...
void LocationQoS::setResponseTime(
    oai::_3gpp::model::ResponseTime const& value) {
...
std::vector<oai::_3gpp::model::MinorLocationQoS> LocationQoS::getMinorLocQoses()
    const {
  return m_MinorLocQoses;
}
void LocationQoS::setMinorLocQoses(
    std::vector<oai::_3gpp::model::MinorLocationQoS> const& value) {
