...
bool SmPolicyUpdateContextData::validate(
  ...
  if (repPolicyCtrlReqTriggersIsSet()) {
    const std::vector<oai::_3gpp::model::PolicyControlRequestTrigger>& value =
    ...
    {  // Recursive validation of array elements
      ...
      int i                          = 0;
      for (const oai::_3gpp::model::PolicyControlRequestTrigger& value :
           value) {
        const std::string currentValuePath =
  ...
  if (accuUsageReportsIsSet()) {
    const std::vector<oai::_3gpp::model::AccuUsageReport>& value =
        m_AccuUsageReports;
  ...
  if (appDetectionInfosIsSet()) {
    const std::vector<oai::_3gpp::model::AppDetectionInfo>& value =
        m_AppDetectionInfos;
  ...
  if (mulAddrInfosIsSet()) {
    const std::vector<oai::_3gpp::model::IpMulticastAddressInfo>& value =
        m_MulAddrInfos;
...
bool SmPolicyUpdateContextData::operator==(
  ...
  return
      ...
      ((!anGwStatusIsSet() && !rhs.anGwStatusIsSet()) ||
       (anGwStatusIsSet() && rhs.anGwStatusIsSet() &&
        isAnGwStatus() == rhs.isAnGwStatus()))
...
void to_json(nlohmann::json& j, const SmPolicyUpdateContextData& o) {
  ...
  if (o.anGwStatusIsSet()) j["anGwStatus"] = o.m_AnGwStatus;
}
...
oai::_3gpp::model::AdditionalAccessInfo
...
oai::_3gpp::model::PlmnIdNid SmPolicyUpdateContextData::getServingNetwork()
    const {
...
oai::_3gpp::model::UserLocation SmPolicyUpdateContextData::getUserLocationInfo()
    const {
...
oai::_3gpp::model::Ipv6Prefix SmPolicyUpdateContextData::getIpv6AddressPrefix()
    const {
...
std::vector<oai::_3gpp::model::AccuUsageReport>
...
std::vector<oai::_3gpp::model::AppDetectionInfo>
...
oai::_3gpp::model::UeInitiatedResourceRequest
...
oai::_3gpp::model::QosFlowUsage SmPolicyUpdateContextData::getQosFlowUsage()
    const {
  return m_QosFlowUsage;
}
void SmPolicyUpdateContextData::setQosFlowUsage(
    oai::_3gpp::model::QosFlowUsage const& value) {
...
oai::_3gpp::model::CreditManagementStatus
...
oai::_3gpp::model::ServingNfIdentity SmPolicyUpdateContextData::getServNfId()
    const {
  return m_ServNfId;
}
...
oai::_3gpp::model::MaPduIndication SmPolicyUpdateContextData::getMaPduInd()
    const {
  return m_MaPduInd;
}
...
oai::_3gpp::model::AtsssCapability SmPolicyUpdateContextData::getAtsssCapab()
    const {
  return m_AtsssCapab;
}
...
oai::_3gpp::model::TsnBridgeInfo SmPolicyUpdateContextData::getTsnBridgeInfo()
    const {
  return m_TsnBridgeInfo;
}
void SmPolicyUpdateContextData::setTsnBridgeInfo(
    oai::_3gpp::model::TsnBridgeInfo const& value) {
...
std::vector<oai::_3gpp::model::IpMulticastAddressInfo>
...
SmPolicyUpdateContextData::getInvalidPolicyDecs() const {
...
SmPolicyUpdateContextData::getSatBackhaulCategory() const {
  return m_SatBackhaulCategory;
}
void SmPolicyUpdateContextData::setSatBackhaulCategory(
...
oai::_3gpp::model::PcfUeCallbackInfo SmPolicyUpdateContextData::getPcfUeInfo()
    const {
  return m_PcfUeInfo;
}
void SmPolicyUpdateContextData::setPcfUeInfo(
...
SmPolicyUpdateContextData::getNwdafDatas() const {
  return m_NwdafDatas;
}
void SmPolicyUpdateContextData::setNwdafDatas(
