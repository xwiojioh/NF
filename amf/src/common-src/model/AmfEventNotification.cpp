...
bool AmfEventNotification::operator==(const AmfEventNotification& rhs) const {
  return
      ...
      ((!eventSubsSyncInfoIsSet() && !rhs.eventSubsSyncInfoIsSet()) ||
       (eventSubsSyncInfoIsSet() && rhs.eventSubsSyncInfoIsSet() &&
        getEventSubsSyncInfo() == rhs.getEventSubsSyncInfo()))
...
AmfEventNotification::getReportList() const {
  return m_ReportList;
}
...
oai::_3gpp::model::AmfEventSubsSyncInfo
AmfEventNotification::getEventSubsSyncInfo() const {
