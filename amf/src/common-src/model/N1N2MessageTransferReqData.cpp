...
oai::_3gpp::model::RefToBinaryData N1N2MessageTransferReqData::getMtData()
    const {
  return m_MtData;
}
...
oai::_3gpp::model::AreaOfValidity
...
void N1N2MessageTransferReqData::setAreaOfValidity(
    oai::_3gpp::model::AreaOfValidity const& value) {
...
oai::_3gpp::model::AccessType N1N2MessageTransferReqData::getTargetAccess()
    const {
