...
oai::_3gpp::model::NssfEventType NssfEventSubscriptionCreateData::getEvent()
    const {
  return m_Event;
}
void NssfEventSubscriptionCreateData::setEvent(
    oai::_3gpp::model::NssfEventType const& value) {
  m_Event = value;
}
