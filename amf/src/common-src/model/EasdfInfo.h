...
class EasdfInfo {
 public:
  ...
  ///
  /// </summary>
  std::vector<oai::_3gpp::model::SnssaiEasdfInfoItem> getSNssaiEasdfInfoList()
      const;
  void setSNssaiEasdfInfoList(
