...
void from_json(const nlohmann::json& j, PolicyControlRequestTrigger_anyOf& o) {
  ...
  if (s == "PLMN_CH") {
    ...
    o.setValue(PolicyControlRequestTrigger_anyOf::
                   ePolicyControlRequestTrigger_anyOf::RAI_CH);
  } else if (s == "RAT_TY_CH") {
    o.setValue(PolicyControlRequestTrigger_anyOf::
    ...
    o.setValue(PolicyControlRequestTrigger_anyOf::
                   ePolicyControlRequestTrigger_anyOf::USER_LOCATION_CH);
    ...
    o.setValue(PolicyControlRequestTrigger_anyOf::
                   ePolicyControlRequestTrigger_anyOf::SUCC_QOS_UPDATE);
  } else if (s == "SAT_CATEGORY_CHG") {
    o.setValue(PolicyControlRequestTrigger_anyOf::
                   ePolicyControlRequestTrigger_anyOf::SAT_CATEGORY_CHG);
  } else if (s == "PCF_UE_NOTIF_IND") {
    o.setValue(PolicyControlRequestTrigger_anyOf::
                   ePolicyControlRequestTrigger_anyOf::PCF_UE_NOTIF_IND);
  } else if (s == "NWDAF_DATA_CHG") {
    o.setValue(PolicyControlRequestTrigger_anyOf::
                   ePolicyControlRequestTrigger_anyOf::NWDAF_DATA_CHG);
  } else {
    std::stringstream ss;
