...
class RgWirelineCharacteristicsRm {
 public:
  ...
  /* NullValue getValue() const;
   ...
   friend void from_json(const nlohmann::json& j, RgWirelineCharacteristicsRm&
   o); friend void to_json(nlohmann::json& j, const NullValue& o); friend void
   from_json(const nlohmann::json& j, NullValue& o);
   */
 protected:
  // NullValue m_value;
};
