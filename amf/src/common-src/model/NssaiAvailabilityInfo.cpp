...
bool NssaiAvailabilityInfo::validate(
  ...
  /* SupportedNssaiAvailabilityData */ {
    const std::vector<oai::_3gpp::model::SupportedNssaiAvailabilityData>&
        value = m_SupportedNssaiAvailabilityData;
    ...
    {  // Recursive validation of array elements
      ...
      int i                          = 0;
      for (const oai::_3gpp::model::SupportedNssaiAvailabilityData& value :
           value) {
        const std::string currentValuePath =
...
void NssaiAvailabilityInfo::setSupportedNssaiAvailabilityData(
    std::vector<oai::_3gpp::model::SupportedNssaiAvailabilityData> const&
        value) {
