...
bool AdditionalMeasurement::validate(
  ...
  if (unexpFlowTepsIsSet()) {
    const std::vector<oai::_3gpp::model::IpEthFlowDescription>& value =
        m_UnexpFlowTeps;
  ...
  if (circumsIsSet()) {
    const std::vector<oai::_3gpp::model::CircumstanceDescription>& value =
        m_Circums;
...
void AdditionalMeasurement::setUnexpLoc(
...
std::vector<oai::_3gpp::model::IpEthFlowDescription>
AdditionalMeasurement::getUnexpFlowTeps() const {
...
void AdditionalMeasurement::setDdosAttack(
    oai::_3gpp::model::AddressList const& value) {
  m_DdosAttack      = value;
...
void AdditionalMeasurement::setWrgDest(
    oai::_3gpp::model::AddressList const& value) {
  m_WrgDest      = value;
  m_WrgDestIsSet = true;
}
...
std::vector<oai::_3gpp::model::CircumstanceDescription>
AdditionalMeasurement::getCircums() const {
  return m_Circums;
}
