...
typedef enum {
  ...
  SBI_BCF_REGISTER_NF_INSTANCE_REQUEST,
  SBI_BCF_REGISTER_NF_INSTANCE_RESPONSE,
  SBI_BCF_UPDATE_NF_INSTANCE_REQUEST,
  SBI_BCF_UPDATE_NF_INSTANCE_RESPONSE,
  SBI_BCF_DEREGISTER_NF_INSTANCE_REQUEST,
  SBI_BCF_DEREGISTER_NF_INSTANCE_RESPONSE,
