...
bool SmPolicyContextData::validate(
  ...
  if (ipv6FrameRouteListIsSet()) {
    const std::vector<oai::_3gpp::model::Ipv6Prefix>& value =
...
bool SmPolicyContextData::operator==(const SmPolicyContextData& rhs) const {
  return
      ...
      ((!onboardIndIsSet() && !rhs.onboardIndIsSet()) ||
       (onboardIndIsSet() && rhs.onboardIndIsSet() &&
        isOnboardInd() == rhs.isOnboardInd())) &&
...
void to_json(nlohmann::json& j, const SmPolicyContextData& o) {
  ...
  if (o.onboardIndIsSet()) j["onboardInd"] = o.m_OnboardInd;
...
void SmPolicyContextData::setAccNetChId(
    oai::_3gpp::model::AccNetChId const& value) {
  m_AccNetChId      = value;
...
oai::_3gpp::model::AccNetChargingAddress
...
oai::_3gpp::model::PduSessionType SmPolicyContextData::getPduSessionType()
    const {
...
oai::_3gpp::model::AdditionalAccessInfo SmPolicyContextData::getAddAccessInfo()
    const {
...
oai::_3gpp::model::UserLocation SmPolicyContextData::getUserLocationInfo()
    const {
...
oai::_3gpp::model::Ipv6Prefix SmPolicyContextData::getIpv6AddressPrefix()
    const {
...
oai::_3gpp::model::SubscribedDefaultQos SmPolicyContextData::getSubsDefQos()
    const {
  return m_SubsDefQos;
}
...
void SmPolicyContextData::setVplmnQos(
...
SmPolicyContextData::getSatBackhaulCategory() const {
...
void SmPolicyContextData::setPcfUeInfo(
...
SmPolicyContextData::getPvsInfo() const {
  return m_PvsInfo;
}
void SmPolicyContextData::setPvsInfo(
...
std::vector<oai::_3gpp::model::NwdafData> SmPolicyContextData::getNwdafDatas()
    const {
  return m_NwdafDatas;
}
void SmPolicyContextData::setNwdafDatas(
