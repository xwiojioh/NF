...
bool GeographicArea::validate(
  ...
  /* PointList */ {
    const std::vector<oai::_3gpp::model::GeographicalCoordinates>& value =
        m_PointList;
...
oai::_3gpp::model::UncertaintyEllipse GeographicArea::getUncertaintyEllipse()
    const {
...
std::vector<oai::_3gpp::model::GeographicalCoordinates>
