...
std::vector<oai::_3gpp::model::AmfEvent> AmfEventSubscription::getEventList()
    const {
  return m_EventList;
}
void AmfEventSubscription::setEventList(
...
void AmfEventSubscription::setExcludeSupiList(
...
void AmfEventSubscription::setExcludeGpsiList(
    std::vector<std::string> const& value) {
...
void AmfEventSubscription::setIncludeSupiList(
    std::vector<std::string> const& value) {
...
void AmfEventSubscription::setIncludeGpsiList(
    std::vector<std::string> const& value) {
...
void AmfEventSubscription::setOptions(
...
void AmfEventSubscription::setSourceNfType(
