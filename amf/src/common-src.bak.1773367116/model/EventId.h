 ...
 * load level information of corresponding network slice. - NETWORK_PERFORMANCE:
 ...
 * associated Network Slice Instance. - SM_CONGESTION: Represent the analytics
 * of Session Management congestion control experience information for specific
 * DNN and/or S-NSSAI. - DISPERSION: Represents the analytics of dispersion. -
...
/// and the optionally associated Network Slice Instance. - SM_CONGESTION:
/// Represent the analytics of Session Management congestion control experience
/// information for specific DNN and/or S-NSSAI. - DISPERSION: Represents the
/// analytics of dispersion. - RED_TRANS_EXP: Represents the analytics of
/// Redundant Transmission Experience. - WLAN_PERFORMANCE: Represents the
/// analytics of WLAN performance. - DN_PERFORMANCE: Represents the analytics of
/// DN performance.
/// </summary>
class EventId {
 public:
