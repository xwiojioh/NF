...
oai::_3gpp::model::UserLocation SmPolicyDeleteData::getUserLocationInfo()
    const {
...
oai::_3gpp::model::PduSessionRelCause SmPolicyDeleteData::getPduSessRelCause()
    const {
  return m_PduSessRelCause;
}
void SmPolicyDeleteData::setPduSessRelCause(
    oai::_3gpp::model::PduSessionRelCause const& value) {
