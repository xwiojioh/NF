...
oai::_3gpp::model::AfEventNotification PduSessionEventNotification::getEvNotif()
    const {
  return m_EvNotif;
}
void PduSessionEventNotification::setEvNotif(
    oai::_3gpp::model::AfEventNotification const& value) {
  m_EvNotif = value;
}
...
oai::_3gpp::model::PduSessionStatus PduSessionEventNotification::getStatus()
    const {
  return m_Status;
}
...
oai::_3gpp::model::PcfAddressingInfo PduSessionEventNotification::getPcfInfo()
    const {
  return m_PcfInfo;
}
void PduSessionEventNotification::setPcfInfo(
    oai::_3gpp::model::PcfAddressingInfo const& value) {
  m_PcfInfo      = value;
  m_PcfInfoIsSet = true;
}
