...
bool UeInitiatedResourceRequest::validate(
  ...
  /* PackFiltInfo */ {
    const std::vector<oai::_3gpp::model::PacketFilterInfo>& value =
        m_PackFiltInfo;
...
void UeInitiatedResourceRequest::setRuleOp(
    oai::_3gpp::model::RuleOperation const& value) {
  m_RuleOp = value;
}
...
std::vector<oai::_3gpp::model::PacketFilterInfo>
...
void UeInitiatedResourceRequest::setReqQos(
    oai::_3gpp::model::RequestedQos const& value) {
  m_ReqQos      = value;
  m_ReqQosIsSet = true;
}
