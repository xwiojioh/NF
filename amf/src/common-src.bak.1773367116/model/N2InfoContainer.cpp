...
bool N2InfoContainer::operator==(const N2InfoContainer& rhs) const {
  return
      ...
      ((!proseInfoIsSet() && !rhs.proseInfoIsSet()) ||
       (proseInfoIsSet() && rhs.proseInfoIsSet() &&
        getProseInfo() == rhs.getProseInfo()))
...
void to_json(nlohmann::json& j, const N2InfoContainer& o) {
  ...
  if (o.proseInfoIsSet()) j["proseInfo"] = o.m_ProseInfo;
}
...
oai::_3gpp::model::N2InformationClass N2InfoContainer::getN2InformationClass()
    const {
...
void N2InfoContainer::setSmInfo(
    oai::_3gpp::model::N2SmInformation const& value) {
  m_SmInfo      = value;
  m_SmInfoIsSet = true;
}
...
void N2InfoContainer::setRanInfo(
    oai::_3gpp::model::N2RanInformation const& value) {
  m_RanInfo      = value;
  m_RanInfoIsSet = true;
}
...
void N2InfoContainer::setNrppaInfo(
    oai::_3gpp::model::NrppaInformation const& value) {
  m_NrppaInfo      = value;
...
void N2InfoContainer::setPwsInfo(
    oai::_3gpp::model::PwsInformation const& value) {
  m_PwsInfo      = value;
  m_PwsInfoIsSet = true;
}
...
void N2InfoContainer::setV2xInfo(
    oai::_3gpp::model::V2xInformation const& value) {
  m_V2xInfo      = value;
  m_V2xInfoIsSet = true;
}
...
void N2InfoContainer::setProseInfo(
    oai::_3gpp::model::ProSeInformation const& value) {
  m_ProseInfo      = value;
