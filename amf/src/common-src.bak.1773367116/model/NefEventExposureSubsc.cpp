...
bool NefEventExposureSubsc::validate(
  ...
  if (eventNotifsIsSet()) {
    const std::vector<oai::_3gpp::model::NefEventNotification>& value =
        m_EventNotifs;
...
std::vector<oai::_3gpp::model::NefEventSubs>
NefEventExposureSubsc::getEventsSubs() const {
  return m_EventsSubs;
}
void NefEventExposureSubsc::setEventsSubs(
    std::vector<oai::_3gpp::model::NefEventSubs> const& value) {
  m_EventsSubs = value;
}
oai::_3gpp::model::ReportingInformation
NefEventExposureSubsc::getEventsRepInfo() const {
...
std::vector<oai::_3gpp::model::NefEventNotification>
NefEventExposureSubsc::getEventNotifs() const {
