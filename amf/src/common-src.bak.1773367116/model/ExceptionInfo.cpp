...
void ExceptionInfo::setIpTrafficFilter(
...
oai::_3gpp::model::EthFlowDescription ExceptionInfo::getEthTrafficFilter()
    const {
  return m_EthTrafficFilter;
}
void ExceptionInfo::setEthTrafficFilter(
