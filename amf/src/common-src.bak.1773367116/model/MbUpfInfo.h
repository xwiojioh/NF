...
class MbUpfInfo {
 public:
  ...
  ///
  /// </summary>
  std::vector<oai::_3gpp::model::SnssaiUpfInfoItem> getSNssaiMbUpfInfoList()
      const;
  void setSNssaiMbUpfInfoList(
  ...
  getInterfaceMbUpfInfoList() const;
  void setInterfaceMbUpfInfoList(
