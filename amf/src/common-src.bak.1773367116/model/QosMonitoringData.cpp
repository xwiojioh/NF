...
bool QosMonitoringData::validate(
  ...
  /* RepFreqs */ {
    const std::vector<oai::_3gpp::model::ReportingFrequency>& value =
        m_RepFreqs;
...
std::vector<oai::_3gpp::model::ReportingFrequency>
QosMonitoringData::getRepFreqs() const {
  return m_RepFreqs;
}
void QosMonitoringData::setRepFreqs(
    std::vector<oai::_3gpp::model::ReportingFrequency> const& value) {
  m_RepFreqs = value;
}
