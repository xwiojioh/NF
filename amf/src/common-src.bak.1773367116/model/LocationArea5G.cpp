...
bool LocationArea5G::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "LocationArea5G" : pathPrefix;
...
LocationArea5G::getGeographicAreas() const {
...
std::vector<oai::_3gpp::model::CivicAddress> LocationArea5G::getCivicAddresses()
    const {
  return m_CivicAddresses;
}
void LocationArea5G::setCivicAddresses(
...
void LocationArea5G::setNwAreaInfo(
