...
bool SmPolicyDecision::validate(
  ...
  if (sessRulesIsSet()) {
    const std::map<std::string, oai::_3gpp::model::SessionRule>& value =
        m_SessRules;
  ...
  if (chgDecsIsSet()) {
    const std::map<std::string, oai::_3gpp::model::ChargingData>& value =
        m_ChgDecs;
    const std::string currentValuePath = _pathPrefix + ".chgDecs";
  }

  if (traffContDecsIsSet()) {
    const std::map<std::string, oai::_3gpp::model::TrafficControlData>& value =
        m_TraffContDecs;
    const std::string currentValuePath = _pathPrefix + ".traffContDecs";
  }

  if (umDecsIsSet()) {
    const std::map<std::string, oai::_3gpp::model::UsageMonitoringData>& value =
        m_UmDecs;
    const std::string currentValuePath = _pathPrefix + ".umDecs";
  }

  if (qosCharsIsSet()) {
    const std::map<std::string, oai::_3gpp::model::QosCharacteristics>& value =
        m_QosChars;
    const std::string currentValuePath = _pathPrefix + ".qosChars";
  }

  if (qosMonDecsIsSet()) {
    const std::map<std::string, oai::_3gpp::model::QosMonitoringData>& value =
        m_QosMonDecs;
    const std::string currentValuePath = _pathPrefix + ".qosMonDecs";
  }

  if (condsIsSet()) {
    const std::map<std::string, oai::_3gpp::model::ConditionData>& value =
        m_Conds;
  ...
  if (lastReqRuleDataIsSet()) {
    const std::vector<oai::_3gpp::model::RequestedRuleData>& value =
        m_LastReqRuleData;
...
bool SmPolicyDecision::operator==(const SmPolicyDecision& rhs) const {
  return
      ...
      ((!offlineChOnlyIsSet() && !rhs.offlineChOnlyIsSet()) ||
       (offlineChOnlyIsSet() && rhs.offlineChOnlyIsSet() &&
        isOfflineChOnly() == rhs.isOfflineChOnly())) &&
...
void to_json(nlohmann::json& j, const SmPolicyDecision& o) {
  ...
  if (o.offlineChOnlyIsSet()) j["offlineChOnly"] = o.m_OfflineChOnly;
...
std::map<std::string, oai::_3gpp::model::SessionRule>
...
std::map<std::string, oai::_3gpp::model::PccRule>
...
std::map<std::string, oai::_3gpp::model::QosData> SmPolicyDecision::getQosDecs()
    const {
  return m_QosDecs;
}
...
std::map<std::string, oai::_3gpp::model::ChargingData>
...
oai::_3gpp::model::ChargingInformation SmPolicyDecision::getChargingInfo()
    const {
...
void SmPolicyDecision::setTraffContDecs(
    std::map<std::string, oai::_3gpp::model::TrafficControlData> const& value) {
...
std::map<std::string, oai::_3gpp::model::UsageMonitoringData>
...
std::map<std::string, oai::_3gpp::model::QosCharacteristics>
SmPolicyDecision::getQosChars() const {
  return m_QosChars;
}
void SmPolicyDecision::setQosChars(
    std::map<std::string, oai::_3gpp::model::QosCharacteristics> const& value) {
  m_QosChars      = value;
...
std::map<std::string, oai::_3gpp::model::QosMonitoringData>
...
std::map<std::string, oai::_3gpp::model::ConditionData>
...
std::vector<oai::_3gpp::model::RequestedRuleData>
...
oai::_3gpp::model::RequestedUsageData SmPolicyDecision::getLastReqUsageData()
    const {
  return m_LastReqUsageData;
}
void SmPolicyDecision::setLastReqUsageData(
    oai::_3gpp::model::RequestedUsageData const& value) {
...
std::map<std::string, oai::_3gpp::model::PresenceInfoRm>
