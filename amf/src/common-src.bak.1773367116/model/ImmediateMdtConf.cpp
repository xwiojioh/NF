...
bool ImmediateMdtConf::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "ImmediateMdtConf" : pathPrefix;
...
ImmediateMdtConf::getMeasurementLteList() const {
...
ImmediateMdtConf::getMeasurementNrList() const {
...
ImmediateMdtConf::getReportingTriggerList() const {
...
oai::_3gpp::model::ReportIntervalMdt ImmediateMdtConf::getReportInterval()
    const {
  return m_ReportInterval;
}
void ImmediateMdtConf::setReportInterval(
...
oai::_3gpp::model::ReportIntervalNrMdt ImmediateMdtConf::getReportIntervalNr()
    const {
  return m_ReportIntervalNr;
}
void ImmediateMdtConf::setReportIntervalNr(
...
void ImmediateMdtConf::setReportAmount(
...
ImmediateMdtConf::getCollectionPeriodRmmLte() const {
...
ImmediateMdtConf::getCollectionPeriodRmmNr() const {
...
ImmediateMdtConf::getMeasurementPeriodLte() const {
...
oai::_3gpp::model::PositioningMethodMdt ImmediateMdtConf::getPositioningMethod()
    const {
  return m_PositioningMethod;
}
void ImmediateMdtConf::setPositioningMethod(
...
ImmediateMdtConf::getAddPositioningMethodList() const {
...
ImmediateMdtConf::getMdtAllowedPlmnIdList() const {
...
ImmediateMdtConf::getSensorMeasurementList() const {
