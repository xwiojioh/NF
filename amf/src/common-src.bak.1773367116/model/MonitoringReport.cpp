...
oai::_3gpp::model::ReachabilityForSmsReport
MonitoringReport::getReachabilityForSmsReport() const {
...
oai::_3gpp::model::ReachabilityReport MonitoringReport::getReachabilityReport()
    const {
  return m_ReachabilityReport;
}
void MonitoringReport::setReachabilityReport(
