...
oai::_3gpp::model::SvcExperience ServiceExperienceInfoPerFlow::getSvcExprc()
    const {
  return m_SvcExprc;
}
void ServiceExperienceInfoPerFlow::setSvcExprc(
...
oai::_3gpp::model::TimeWindow ServiceExperienceInfoPerFlow::getTimeIntev()
    const {
  return m_TimeIntev;
}
void ServiceExperienceInfoPerFlow::setTimeIntev(
...
oai::_3gpp::model::FlowInfo ServiceExperienceInfoPerFlow::getIpTrafficFilter()
    const {
  return m_IpTrafficFilter;
}
void ServiceExperienceInfoPerFlow::setIpTrafficFilter(
...
oai::_3gpp::model::EthFlowDescription
ServiceExperienceInfoPerFlow::getEthTrafficFilter() const {
  return m_EthTrafficFilter;
}
void ServiceExperienceInfoPerFlow::setEthTrafficFilter(
    oai::_3gpp::model::EthFlowDescription const& value) {
