...
bool RequestedRuleData::validate(
  ...
  /* ReqData */ {
    const std::vector<oai::_3gpp::model::RequestedRuleDataType>& value =
        m_ReqData;
...
std::vector<oai::_3gpp::model::RequestedRuleDataType>
RequestedRuleData::getReqData() const {
  return m_ReqData;
}
void RequestedRuleData::setReqData(
    std::vector<oai::_3gpp::model::RequestedRuleDataType> const& value) {
  m_ReqData = value;
}
